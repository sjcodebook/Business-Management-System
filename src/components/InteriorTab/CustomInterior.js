...
const CustomInterior = ({ editMode, data, onClose }) => {
  ...
  const handleSubmit = () => {
    if (editMode) {
      ...
      estimatorStore.setFinalEstimate('customInterior', {
        name,
        price: round(price, 2),
        notes,
        prepWork,
        ...
        <Card className={classes.cardRoot}>
          <CardContent>
            ...
            <div className={classes.form}>
              <TextField
                id='outlined-custom-int-name-input'
                label='Nom'
                type='text'
                variant='outlined'
                value={name}
              ...
              />
              <TextField
                id='outlined-custom-int-price-input'
                label='Prix'
                type='text'
                variant='outlined'
                value={price}
              ...
              />
              <TextField
                id='outlined-custom-int-notes-input'
                label='Notes'
                type='text'
                variant='outlined'
                value={notes}
              ...
              />
              <TextField
                id='outlined-custom-int-prep-input'
                label='Préparation'
                type='text'
                variant='outlined'
                value={prepWork}
