...
import { fetchWeekEntries, getUserById } from './../../../scripts/remoteActions'
...
const SalaryModal = ({ onClose, weekStart, weekEnd }) => {
      ...
      <TableRow>
        ...
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={8}>
          <Collapse style={{ padding: 10 }} in={open} timeout='auto' unmountOnExit>
            <MoreInfoTable entries={info.entries} user={info.userInfo} />
          </Collapse>
        </TableCell>
      </TableRow>
    </Fragment>
...
const MoreInfoTable = ({ entries, user }) => {
  return (
    <Box
      margin={1}
      style={{
